<template>
    <SubHero title="company" title-content="会社"></SubHero>
    ...
    <main class="l-contents flex flex-col items-center">
        <section class="p-greeting l-section">
            <div class="p-greeting__inner l-inner flex flex-col items-center">
        ...
        <section class="p-company-info l-section">
            <div class="l-inner">
                <div class="p-company-info__heading w-full">
                    <h3 class="c-heading-secondary">会社概要</h3>
                </div>
                <div class="p-company-info__table w-full">
                    <table class="c-table01 border-collapse ">
                        <tr>
                            <th>社名</th>
